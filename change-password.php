...
$udate=date('d-m-Y h:i:s', time());;
	$sql="SELECT password FROM students where password=?";
	...
	if($row_cnt>0)
	{
		$con="update students set password=?,passUdateDate=?  where id=?";
...
<?php $result ="SELECT passUdateDate FROM students WHERE id=?";
