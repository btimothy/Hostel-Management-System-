...
{
$query="insert into  rooms (seater,room_no,Level,fees) values(?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiii',$seater,$roomno,$rooml,$fees);
$stmt->execute();
...
<div class="form-group">
<label class="col-sm-2 control-label">Level.
</label>
<div class="col-sm-8">
<input type="text" class="form-control" name="rml" id="rml" value="" required="required">
</div>
</div>
<div class="form-group">
