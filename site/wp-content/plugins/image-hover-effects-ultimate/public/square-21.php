...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    if (!wp_verify_nonce($nonce, 'iheueffectsstyle')) {
        ...
        $data = 'iheu-item |' . sanitize_text_field($_POST['iheu-item']) . '|'
                . 'hover-height |' . sanitize_text_field($_POST['hover-height']) . '|'
                            ...
                            <div class="ctu-ultimate-style-3-content">
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-6">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="hover-height" class="col-sm-6 oxi-control-label" data-toggle="tooltip" data-placement="top" title="Set Hover Height, Based on Percentize" >Hover Height</label>
                                            <div class="col-sm-6 nopadding">
                                                <input type="number" class="form-control" min="100" max="150" step="1" id="hover-height" name="hover-height" value="<?php echo $styledata[3]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row form-group-sm">
