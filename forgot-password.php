...
$stmt=$mysqli->prepare("SELECT email,contactNo,password FROM studnts WHERE (email=? && contactNo=?) ");
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-blue mt-4x">Forgot Password</h1>
